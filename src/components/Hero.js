...
import Photo from "../contents/Intropagepic.jpg";
      ...
      <article className="introContent">
        <div className="introText">
          ...
          <div className={`introButtons ${darkMode ? "dark-mode" : ""}`}>
            <a
              href="mailto:kizilatesemrecan@gmail.com"
              style={{
        ...
        <div>
          <img className="introImage" src={Photo} alt="ProfilePhoto" />
        </div>
      </article>
    </div>
  );
